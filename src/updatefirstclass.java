...
/**
 * Servlet implementation class updatefirstclass
 */
public class updatefirstclass extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updatefirstclass() {
        super();
...
st.executeUpdate("update trains set first_class='"+First_class+"' where train_no='"+train_no+"' ");
...
out.println("<center>");
out.println("<br><br><br><h1><font face='cooper' color='yellow'>First Class cost numbered : "+train_no+" updated successfully!!!</font></h1><br><br>");
