...
/**
 * Servlet implementation class update_sleeperseats
 */
public class update_sleeperseats extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public update_sleeperseats() {
        super();
		...
		response.getWriter().append("Served at: ").append(request.getContextPath());
		 ...
		 try {
		  ...
		  //  int i=	st.executeUpdate("update train3 set train_name='"+train_name+"',type='"+type+"',from_station='"+from_station+"', to_station='"+to_station+"',first_class='"+First_class+"', AC_1_tier='"+AC_1_tier+"',AC_2_tier='"+AC_2_tier+"',AC_3_tier='"+AC_3_tier+"',sleeper='"+sleeper_class+"',second class='"+second_class+"' where train_no='"+train_no+"' ");
					  ...
					  st.executeUpdate("update trains set sleeper_class_seats='"+sleeper_class_seats+"' where train_no='"+train_no+"' ");
					  ...
					  out.println("<center>");
					  out.println("<br><br><br><h1><font face='cooper' color='yellow'>Sleeper Class Seats numbered : "+train_no+" updated successfully!!!</font></h1><br><br>");
