...
/**
 * Servlet implementation class update_departure
 */
public class update_departure extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public update_departure() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try { PrintWriter out=response.getWriter();
		  ...
		  //  int i=	st.executeUpdate("update train3 set train_name='"+train_name+"',type='"+type+"',from_station='"+from_station+"', to_station='"+to_station+"',first_class='"+First_class+"', AC_1_tier='"+AC_1_tier+"',AC_2_tier='"+AC_2_tier+"',AC_3_tier='"+AC_3_tier+"',sleeper='"+sleeper_class+"',second class='"+second_class+"' where train_no='"+train_no+"' ");
					 ...
					 st.executeUpdate("update trains set departure='"+departure+"' where train_no='"+train_no+"' ");
					 
					 
					 out.println("<html>");
					  out.println("<body bgcolor='black'>");
					  out.println("<center>");
					  out.println("<br><br><br><h1><font face='cooper' color='yellow'>Departure Time numbered : "+train_no+" updated successfully!!!</font></h1><br><br>");
